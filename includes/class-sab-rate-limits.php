...
class SAB_Rate_Limits {
    ...
    const MODELS = [
        ...
        // ── Google Gemini Text Models (Synchronized with AI Studio Quotas) ────
        'gemini-3.1-flash-lite-preview' => [
            'label'       => 'Gemini 3.1 Flash Lite ⭐ (Best Free - 500 RPD / 15 RPM / 250K TPM)',
        ...
        'gemini-3.5-flash-lite' => [
            'label'       => 'Gemini 3.5 Flash Lite ⭐ (500 RPD / 15 RPM / 250K TPM)',
        ...
        'gemini-3.7-flash' => [
            'label'       => 'Gemini 3.7 Flash (20 RPD / 5 RPM / 250K TPM)',
        ...
        'gemini-3.6-flash' => [
            'label'       => 'Gemini 3.6 Flash (20 RPD / 5 RPM / 250K TPM)',
        ...
        'gemini-3.5-flash' => [
            'label'       => 'Gemini 3.5 Flash (20 RPD / 5 RPM / 250K TPM)',
        ...
        'gemini-3-flash' => [
            'label'       => 'Gemini 3 Flash (20 RPD / 5 RPM / 250K TPM)',
        ...
        'gemini-2.5-flash-lite' => [
            'label'       => 'Gemini 2.5 Flash Lite (20 RPD / 10 RPM / 250K TPM)',
        ...
        'gemini-2.5-flash' => [
            'label'       => 'Gemini 2.5 Flash (20 RPD / 5 RPM / 250K TPM)',
        ...
        'gemini-2.5-pro' => [
            'label'       => 'Gemini 2.5 Pro (Paid Tier Only)',
        ...
        'gemini-2.0-pro-exp-02-05' => [
            ...
            'api_id'      => 'gemini-2.0-pro-exp-02-05',
            'rpm'         => 2,
            'tpm'         => 32000,
            'rpd'         => 50,
            'type'        => 'text',
        ...
        'gemini-2.0-flash-thinking-exp-01-21' => [
            'label'       => 'Gemini 2.0 Flash Thinking Exp (Reasoning)',
            'api_id'      => 'gemini-2.0-flash-thinking-exp-01-21',
            'rpm'         => 10,
            'tpm'         => 400000,
            'rpd'         => 1500,
            'type'        => 'text',
        ...
        'gemini-1.5-flash-8b' => [
            'label'       => 'Gemini 1.5 Flash-8B (High Speed Light)',
            'api_id'      => 'gemini-1.5-flash-8b',
            'rpm'         => 15,
            'tpm'         => 1000000,
            'rpd'         => 1500,
            'type'        => 'text',
        ...
        'gpt-4o' => [
            'label'       => 'GPT-4o (High Intelligence Flagship)',
            'api_id'      => 'gpt-4o',
            'rpm'         => 3,
            'tpm'         => 30000,
            'rpd'         => 500,
        ...
        'gpt-4.5-preview' => [
            'label'       => 'GPT-4.5 Preview (Largest OpenAI Model)',
            'api_id'      => 'gpt-4.5-preview',
            'rpm'         => 3,
            'tpm'         => 30000,
            'rpd'         => 500,
            'type'        => 'text',
        ...
        'o1' => [
            'label'       => 'OpenAI o1 (Full Reasoning Model)',
            'api_id'      => 'o1',
            'rpm'         => 3,
            'tpm'         => 50000,
            'rpd'         => 1000,
        ...
        'o1-mini' => [
            'label'       => 'OpenAI o1-mini (Fast Reasoning)',
            'api_id'      => 'o1-mini',
            'rpm'         => 3,
            'tpm'         => 50000,
            'rpd'         => 1000,
    ...
    public static function get_usage( string $hash ) {
        return [
            'rpm' => (int) ( get_transient( 'sab_rpm_' . $hash ) ?: 0 ),
            'tpm' => (int) ( get_transient( 'sab_tpm_' . $hash ) ?: 0 ),
            'rpd' => (int) ( get_transient( 'sab_rpd_' . $hash . '_' . self::today_key() ) ?: 0 ),
        ];
    }
    ...
    public static function reset_counters( string $api_key ) {
        $hash = self::key_hash( $api_key );
        delete_transient( 'sab_rpm_' . $hash );
        delete_transient( 'sab_tpm_' . $hash );
        delete_transient( 'sab_rpd_' . $hash . '_' . self::today_key() );
    }
    ...
    private static function increment_rpd( string $hash ) {
        $key = 'sab_rpd_' . $hash . '_' . self::today_key();
        $val = (int) get_transient( $key );
