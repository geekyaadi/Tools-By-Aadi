<?php
/**
 * Global Site-Wide Speed Optimizer Engine for Soniji Auto Blogging
 */

if ( ! defined( 'ABSPATH' ) ) exit;

class SAB_Speed_Optimizer {
    ...
    public static function init() {
        ...
        if ( get_option( 'sab_speed_webp_compression', '1' ) === '1' ) {
    ...
    public static function inject_resource_hints() {
        echo '<!-- Soniji Auto Blogging Speed Turbo Hints -->' . "\n";
