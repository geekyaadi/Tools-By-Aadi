<?php
/**
 * Global Site-Wide Speed Optimizer Engine for Tools By Aadi
 */

if ( ! defined( 'ABSPATH' ) ) exit;

class TBA_Speed_Optimizer {
    ...
    public static function init() {
        ...
        if ( get_option( 'tba_speed_webp_compression', '1' ) === '1' ) {
    ...
    public static function inject_resource_hints() {
        echo '<!-- Tools By Aadi Speed Turbo Hints -->' . "\n";
