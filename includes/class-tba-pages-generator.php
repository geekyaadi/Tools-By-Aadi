...
Use clean HTML formatting. Do NOT wrap in markdown code blocks.";
        ...
        $content = '';
        if ( class_exists( 'TBA_Gemini' ) && method_exists( 'TBA_Gemini', 'generate_custom_text' ) ) {
            $ai_result = TBA_Gemini::generate_custom_text( $ai_prompt );
...
<div class="tba-contact-box" style="background:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; padding:24px; margin:25px 0;">
