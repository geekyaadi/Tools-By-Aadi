...
<div class="sab-wrap">
    <div class="sab-header">
        <div class="sab-header-inner">
            <div class="sab-logo">
                ...
                <span class="sab-logo-badge">Bulk Translator</span>
            </div>
    ...
    <a href="<?php echo esc_url( admin_url('admin.php?page=sab-translator') ); ?>" class="sab-nav-link active">Translator</a>
    ...
    <div class="sab-content">
        ...
        <div class="sab-panel" style="margin-bottom: 20px;">
            <div class="sab-panel-header">
                <h2 class="sab-panel-title">🌐 Bulk Translation Options</h2>
            </div>
            
            <div style="display:flex; gap: 20px; align-items: flex-end; flex-wrap: wrap;">
                <div class="sab-field" style="flex:1; min-width:200px; margin-bottom:0;">
                    <label class="sab-label">Target Language</label>
                    <select id="sab-translator-target-lang" class="sab-select" style="width:100%; height:38px; padding:6px 12px; border-radius:6px;">
                ...
                <div class="sab-field" style="flex:1; min-width:200px; margin-bottom:0;">
                    <label class="sab-label">Destination Post Status</label>
                    <select id="sab-translator-status" class="sab-select" style="width:100%; height:38px; padding:6px 12px; border-radius:6px;">
                ...
                <div style="flex:1; min-width:220px;">
                    <button type="button" id="sab-btn-translate-selected" class="sab-btn sab-btn-primary" style="background:#4f46e5; border-color:#4f46e5; width:100%; font-weight:600; height:38px; border-radius:6px; padding:0 20px; display:inline-flex; align-items:center; justify-content:center; gap:8px;">
            ...
            <!-- Progress Block -->
            <div id="sab-translator-progress-container" style="display:none; margin-top:20px; border-top:1px solid rgba(255,255,255,0.06); padding-top:20px;">
                <div style="display:flex; justify-content:space-between; margin-bottom:8px; font-weight:600; font-size:13px; color:var(--sab-text-dark);">
                    <span id="sab-trans-progress-text">Processing translation queue...</span>
                    <span id="sab-trans-progress-percent">0%</span>
                </div>
                <div style="background:rgba(255,255,255,0.05); height:8px; border-radius:4px; overflow:hidden; margin-bottom:15px;">
                    <div id="sab-trans-progress-bar" style="background:linear-gradient(90deg, #4f46e5, #06b6d4); width:0%; height:100%; transition: width 0.3s ease;"></div>
                </div>
                <div id="sab-trans-log" style="background:#0f172a; color:#cbd5e1; font-family:monospace; font-size:12px; padding:12px 15px; border-radius:6px; max-height:150px; overflow-y:auto; line-height:1.5;">
        ...
        <div class="sab-panel">
            <div class="sab-panel-header" style="display:flex; justify-content:space-between; align-items:center;">
                <h2 class="sab-panel-title">📚 Select Articles to Translate (Showing <?php echo count($posts); ?> of <?php echo (int) $total_posts; ?>)</h2>
                <div>
                    <label style="font-size:12px; font-weight:600; color:var(--sab-text-muted); cursor:pointer; display:flex; align-items:center; gap:5px;">
                        <input type="checkbox" id="sab-translator-select-all" style="vertical-align:middle; margin:0;"> Select All
                    </label>
                </div>
            </div>

            <?php if ( empty($posts) ): ?>
            <div class="sab-empty-state">No blog posts found on your WordPress site. Create or generate some posts first!</div>
            <?php else: ?>
            <table class="sab-table" id="sab-translator-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" class="sab-translator-checkbox" data-post-id="<?php echo (int) $p->ID; ?>">
                        </td>
                        ...
                        <td>
                            <span class="sab-status-badge <?php echo $p->post_status === 'publish' ? 'sab-status-active' : 'sab-status-exhausted'; ?>">
